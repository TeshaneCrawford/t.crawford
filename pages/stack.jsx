...
export default function Utilities() {
  return (
    <>
      <MetaData
        title={pageMeta.stack.title}
        description={utilities.description}
        previewImage={pageMeta.stack.image}
        keywords={pageMeta.stack.keywords}
      />
      ...
      <section className="pageTop font-inter">
        ...
        <div className="flex flex-col gap-14">
          <UtilitySection utility={utilities.language} />
          <UtilitySection utility={utilities.framework} />
