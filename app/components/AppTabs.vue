        ...
        <nav class="flex gap-4" aria-label="Tabs">
          <div role="tablist" class="flex gap-4">
            <button
              ...
              :class="[
                'py-2 px-1 border-b-2 text-sm font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2',
                activeTab === tab.id
