...
<template>
  <nav class="mt-8 flex items-center justify-between gap-4 border-t border-neutral-200 pt-8">
    <div v-if="prev" class="flex-1">
      <NuxtLink :to="prev._path" class="group flex flex-col">
        <span class="text-sm text-neutral-500">Previous</span>
        <span class="group-hover:text-primary-600 text-lg text-neutral-900 font-medium transition-colors">
          {{ prev.title }}
        </span>
      </NuxtLink>
    </div>
    ...
    <div v-if="next" class="flex-1 text-right">
      <NuxtLink :to="next._path" class="group flex flex-col">
        <span class="text-sm text-neutral-500">Next</span>
        <span class="group-hover:text-primary-600 text-lg text-neutral-900 font-medium transition-colors">
          {{ next.title }}
        </span>
      </NuxtLink>
